...
// lazy loading ile root state e product slice i ekleniyor
...
export function productReducer(
    ...
    switch (action.type) {
        ...
        case productActions.ProductActionTypes.SEARCH_PRODUCTS_SUCCESS: {
          return productAdapter.addAll(action.payload, {
            ...state,
            loading: false,
            loaded: true
        ...
        case productActions.ProductActionTypes.SEARCH_PRODUCTS_FAIL: {
          return {
            ...state,
            entities: {},
            loading: false,
