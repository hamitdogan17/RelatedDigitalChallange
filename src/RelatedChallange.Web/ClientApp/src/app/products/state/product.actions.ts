...
export enum ProductActionTypes {
    ...
    SEARCH_PRODUCTS_FAIL = '[Product] Search Products Fail',
}
...
export class SearchProducts implements Action {
  readonly type = ProductActionTypes.SEARCH_PRODUCTS;

  constructor(public payload: SearchProduct) { }
}

export class SearchProductsSuccess implements Action {
  readonly type = ProductActionTypes.SEARCH_PRODUCTS_SUCCESS;

  constructor(public payload: Product[]) { }
}

export class SearchProductsFail implements Action {
  readonly type = ProductActionTypes.SEARCH_PRODUCTS_FAIL;
